...
export function PageHeader({ kicker, title, sub, children }: { kicker?: string; title: string; sub?: string; children?: ReactNode }) {
  return (
    <section className="relative pt-20 pb-14 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
        {kicker && <div className="inline-block mb-4 px-3 py-1 rounded-full text-xs font-semibold tracking-wider uppercase bg-primary/10 text-primary">{kicker}</div>}

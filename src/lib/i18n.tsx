...
export const dict: Dict = {
  ...
  // home
  "home.role": { uz: "Frontend dasturchi", en: "Frontend Developer", ru: "Frontend разработчик" },
  "home.tagline": {
    uz: "Zamonaviy, tezkor va responsive web saytlar hamda web ilovalar yaratishga ixtisoslashgan Frontend dasturchi.",
    en: "A Frontend Developer specialized in building modern, fast, and responsive websites and web applications.",
    ru: "Frontend разработчик, специализирующийся на создании современных, быстрых и адаптивных сайтов и веб-приложений.",
  },
  ...
  "home.stats.responsive": {
    uz: "Responsive dizayn",
    en: "Responsive Design",
    ru: "Адаптивный дизайн",
  },
  "home.hero.codeBadgeSub": {
    uz: "Ishlab chiqarishga tayyor ilovalar",
    en: "Production ready apps",
    ru: "Готовые к продакшену приложения",
  },
  "home.hero.codeMeta.ts": {
    uz: "TypeScript v5.6",
    en: "TypeScript v5.6",
    ru: "TypeScript v5.6",
  },
  "home.hero.codeMeta.js": {
    uz: "JavaScript ES2024",
    en: "JavaScript ES2024",
    ru: "JavaScript ES2024",
  },
  "home.tech.title": {
    uz: "Ishlatadigan texnologiyalarim",
    en: "My Tech Stack",
    ru: "Мой стек технологий",
  },
  "home.tech.sub": {
    uz: "Har kuni ishlatiladigan asboblar to'plami",
    en: "The toolkit I reach for every day",
    ru: "Инструменты, которые я использую каждый день",
  },
  "home.featured.title": { uz: "Tanlangan ishlar", en: "Featured Work", ru: "Избранные работы" },
  "home.featured.sub": {
    uz: "So'nggi loyihalarim — tafsilotlar bilan tanishing",
    en: "Recent work — explore the details",
    ru: "Недавние проекты — изучите детали",
  },
  "home.featured.all": { uz: "Barcha loyihalar", en: "See all projects", ru: "Все проекты" },
  "home.why.title": {
    uz: "Nima uchun men bilan ishlaysiz",
    en: "Why Work With Me",
    ru: "Почему работать со мной",
  },
  "home.why.1.t": { uz: "Tez yetkazib berish", en: "Fast Delivery", ru: "Быстрая сдача" },
  "home.why.1.d": {
    uz: "Deadline'larga qat'iy amal qilaman va sifatni saqlab qolaman.",
    en: "Ship on time without compromising quality.",
    ru: "Сдаю в срок без потери качества.",
  },
  "home.why.2.t": {
    uz: "Piksel-aniq dizayn",
    en: "Pixel-Perfect Design",
    ru: "Пиксель-перфект дизайн",
  },
  "home.why.2.d": {
    uz: "Figma'dan kodgacha — har bir detal joyida.",
    en: "Figma to code with every detail preserved.",
    ru: "От Figma до кода — каждая деталь на месте.",
  },
  "home.why.3.t": {
    uz: "Toza va kengaytiriladigan kod",
    en: "Clean Scalable Code",
    ru: "Чистый масштабируемый код",
  },
  "home.why.3.d": {
    uz: "Kelajakda oson qo'llab-quvvatlanadigan arxitektura.",
    en: "Architecture that stays maintainable long-term.",
    ru: "Архитектура, которую легко поддерживать.",
  },
  "home.why.4.t": { uz: "Aniq muloqot", en: "Clear Communication", ru: "Чёткая коммуникация" },
  "home.why.4.d": {
    uz: "Jarayonning har bosqichida ochiq va tushunarli.",
    en: "Transparent updates through every stage.",
    ru: "Прозрачные обновления на каждом этапе.",
  },
  "home.closing.title": {
    uz: "Loyihangizni birga boshlaymizmi?",
    en: "Ready to start your project?",
    ru: "Готовы начать проект?",
  },
  "home.closing.sub": {
    uz: "G'oyangizni yuboring — 24 soat ichida javob beraman.",
    en: "Send your idea — I reply within 24 hours.",
    ru: "Отправьте идею — отвечу в течение 24 часов.",
  },
  "home.available": {
    uz: "Frilans uchun ochiq",
    en: "Available for freelance",
    ru: "Открыт для фриланса",
  },

  // about
  "about.title": { uz: "Men haqimda", en: "About Me", ru: "Обо мне" },
  "about.kicker": {
    uz: "Frontend dasturchi · Mars IT School",
    en: "Frontend Developer · Mars IT School",
    ru: "Frontend разработчик · Mars IT School",
  },
  "about.p1": {
    uz: "Men Ilyosxoja Usmonovman — zamonaviy web saytlar va interaktiv web ilovalarni yaratishga qiziqadigan Frontend dasturchiman. Mars IT School'da o'qiyman va HTML, CSS, JavaScript, React.js hamda Tailwind CSS bilan ishlashni yaxshi ko'raman.",
    en: "I'm Ilyosxoja Usmonov — a Frontend Developer passionate about building modern websites and interactive web apps. I study at Mars IT School and work daily with HTML, CSS, JavaScript, React.js and Tailwind CSS.",
    ru: "Я Ilyosxoja Usmonов — Frontend разработчик, увлечённый созданием современных сайтов и интерактивных веб-приложений. Учусь в Mars IT School и ежедневно работаю с HTML, CSS, JavaScript, React.js и Tailwind CSS.",
  },
  "about.p2": {
  ...
  "about.edu": {
    uz: "Ta'lim va o'sish yo'li",
    en: "Education & Learning Journey",
    ru: "Образование и путь развития",
  },
  ...
  "about.freelance.start": {
    uz: "Frilans faoliyati boshlanishi",
    en: "Freelance journey begins",
    ru: "Начало фриланс-деятельности",
  },
  ...
  "about.fullstack": {
    uz: "Full-stack yo'nalishida o'sish",
    en: "Growing into full-stack",
    ru: "Рост в направлении full-stack",
  },
  ...
  "projects.more.title": {
    uz: "Yangi loyihalar tez orada",
    en: "More Projects Coming Soon",
    ru: "Новые проекты скоро",
  },
  "projects.more.sub": {
    uz: "Ustida ishlayotgan yangi ishlarim bilan tez orada bo'lishaman.",
    en: "New case studies are on the way — stay tuned.",
    ru: "Новые кейсы уже в работе — следите за обновлениями.",
  },

  // services
  "services.title": { uz: "Xizmatlar", en: "Services", ru: "Услуги" },
  "services.sub": {
    uz: "Biznesingiz va g'oyangizga mos yechimlar.",
    en: "Solutions tailored to your business or idea.",
    ru: "Решения, адаптированные под ваш бизнес или идею.",
  },
  ...
  "pricing.sub": {
    uz: "Ochiq va tushunarli paketlar. Shaxsiylashtirilgan takliflar ham mavjud.",
    en: "Transparent packages. Custom quotes on request.",
    ru: "Прозрачные пакеты. Индивидуальные предложения по запросу.",
  },
  ...
  "pricing.custom": {
    uz: "Maxsus loyiha kerakmi?",
    en: "Custom project?",
    ru: "Нужен индивидуальный проект?",
  },
  "pricing.custom.body": {
    uz: "G'oyangiz noyob bo'lsa — men bilan bog'laning va maxsus taklif oling.",
    en: "If your idea is unique, get in touch for a custom quote.",
    ru: "Если ваша идея уникальна — свяжитесь со мной для индивидуального предложения.",
  },
  ...
  "blog.sub": {
    uz: "Frontend, JavaScript va React haqida yozuvlar.",
    en: "Notes on frontend, JavaScript and React.",
    ru: "Заметки о frontend, JavaScript и React.",
  },
  "blog.kicker": { uz: "Yozuvlar", en: "Writing", ru: "Статьи" },
  "blog.subscribe": {
    uz: "Telegram kanaliga a'zo bo'ling",
  ...
  "resume.summary.body": {
    uz: "Frontend dasturchi, React va Tailwind CSS bilan zamonaviy interfeyslar yaratadi. Full-stack tomon o'sib bormoqda.",
    en: "Frontend Developer crafting modern interfaces with React and Tailwind CSS, growing toward full-stack.",
    ru: "Frontend разработчик, создающий современные интерфейсы на React и Tailwind CSS, развивается в направлении full-stack.",
  },
  ...
  "resume.testimonials": {
    uz: "Mijozlar fikri (namuna)",
    en: "Testimonials (sample)",
    ru: "Отзывы (пример)",
  },
  ...
  "contact.sub": {
    uz: "Yangi loyihalar uchun ochiqman. Yozing — tez javob beraman.",
    en: "Open for new projects. Drop a message — I'll get back fast.",
    ru: "Открыт для новых проектов. Напишите — отвечу быстро.",
  },
  ...
  "contact.form.sent": {
    ...
    en: "Message received. I'll reply shortly!",
    ru: "Сообщение получено. Скоро отвечу!",
  },
  "contact.next": { uz: "Keyingi qadamlar", en: "What Happens Next", ru: "Что дальше" },
  "contact.available": {
    uz: "Hozirda frilans loyihalari uchun ochiqman",
    en: "Currently available for freelance projects",
    ru: "Сейчас открыт для фриланс-проектов",
  },
  "contact.closing": {
    uz: "Keling, birga ajoyib narsa yaratamiz.",
    en: "Let's build something great together.",
    ru: "Давайте создадим что-то отличное вместе.",
  },
  "contact.telegramChannel": { uz: "Telegram kanal", en: "Telegram channel", ru: "Telegram-канал" },
  "contact.step1": {
    uz: "24 soat ichida javob beraman",
    en: "I'll respond within 24 hours",
    ru: "Отвечу в течение 24 часов",
  },
  "contact.step2": {
    uz: "Loyihani muhokama qilamiz",
    en: "We'll discuss your project",
    ru: "Обсудим ваш проект",
  },
  "contact.step3": {
    uz: "Taklif va vaqt jadvalini yuboraman",
    en: "You'll get a proposal & timeline",
    ru: "Отправлю предложение и сроки",
  },

  // footer
  "footer.tag": {
    uz: "Frontend Developer · Toshkent, O'zbekiston",
    en: "Frontend Developer · Tashkent, Uzbekistan",
    ru: "Frontend Developer · Ташкент, Узбекистан",
  },
  "footer.rights": {

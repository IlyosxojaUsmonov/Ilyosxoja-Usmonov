    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-5 sm:px-8 grid lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          <a href="mailto:frontend.usmonov@gmail.com" className="flex items-center gap-4 p-5 rounded-2xl bg-card border border-border hover:border-primary hover:shadow-lg hover:shadow-primary/10 transition-all">
          ...
          <a href="https://t.me/ilyosxoja_usmonov" className="flex items-center gap-4 p-5 rounded-2xl bg-card border border-border hover:border-primary hover:shadow-lg hover:shadow-primary/10 transition-all">
          ...
          <a href="https://t.me/usmonov_stack" className="flex items-center gap-4 p-5 rounded-2xl bg-card border border-border hover:border-primary hover:shadow-lg hover:shadow-primary/10 transition-all">
          ...
          <a href="https://github.com/IlyosxojaUsmonov" className="flex items-center gap-4 p-5 rounded-2xl bg-card border border-border hover:border-primary hover:shadow-lg hover:shadow-primary/10 transition-all">
